...
export default function AppointmentPage() {
  ...
  return (
    <main className="bg-[#F6F8FB] min-h-screen pt-10 pb-20">
      {/* Appointment Section */}
      <section className="py-16 bg-gradient-to-r from-[#14396D] to-[#2C5078]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <div className="inline-block px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full text-[#FF3D71] font-semibold text-sm mb-4">HEALTHCARE MADE EASY</div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">Manage Your Appointments</h2>
          ...
          {user ? (
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-white/10 max-w-6xl mx-auto">
              {/* Tabs */}
              <div className="flex border-b border-white/20 mb-6">
                <button
                  className={`px-6 py-3 font-semibold text-sm transition-all ${activeTab === 'appointments' ? 'text-white border-b-2 border-[#FF3D71]' : 'text-gray-300 hover:text-white'}`}
                ...
                <button
                  className={`px-6 py-3 font-semibold text-sm transition-all ${activeTab === 'new' ? 'text-white border-b-2 border-[#FF3D71]' : 'text-gray-300 hover:text-white'}`}
              ...
              {activeTab === 'appointments' ? (
                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                  <div className="p-6 bg-gray-50 border-b border-gray-200">
                    <h3 className="text-xl font-bold text-[#14396D]">Book a New Appointment</h3>
                    <p className="text-gray-600 mt-1">Fill out the form below to schedule your appointment with one of our healthcare professionals.</p>
                  </div>
                  <div className="p-6">
                    <BookAppointmentForm />
                  </div>
            ...
            <div className="bg-white rounded-xl shadow-xl p-10 max-w-xl mx-auto text-center">
              <div className="w-20 h-20 bg-[#F6F8FB] rounded-full flex items-center justify-center mx-auto mb-6 shadow-md">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-[#14396D]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-[#14396D] mb-4">Login Required</h3>
              <p className="text-gray-600 mb-8">Please login to your account to view or book appointments. Your secure account helps us provide you with the best care possible.</p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button 
                  className="bg-gradient-to-r from-[#14396D] to-[#2C5078] hover:from-[#2C5078] hover:to-[#14396D] text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex-1 flex items-center justify-center"
                ...
                <button 
                  className="bg-gradient-to-r from-[#FF3D71] to-[#ff5996] hover:from-[#ff5996] hover:to-[#FF3D71] text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex-1 flex items-center justify-center"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#F6F8FB] p-8 rounded-xl shadow-md">
              <div className="w-16 h-16 bg-[#14396D] rounded-full flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-[#14396D] mb-4">Quick Appointments</h3>
            ...
            <div className="bg-[#F6F8FB] p-8 rounded-xl shadow-md">
              ...
              <h3 className="text-xl font-bold text-[#14396D] mb-4">Secure & Private</h3>
            ...
            <div className="bg-[#F6F8FB] p-8 rounded-xl shadow-md">
              ...
              <h3 className="text-xl font-bold text-[#14396D] mb-4">24/7 Support</h3>
